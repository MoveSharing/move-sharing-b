...
const schema = a.schema({
    EngineStatus: a.enum(["STARTING", "STARTED", "STOPPING", "STOPPED"]),
    GeoLocation: a.customType({
    ...
    User: a
        .model({
            ...
            vehicles: a.hasOne("Vehicle", "userId"),
        })
    ...
    Vehicle: a.model({
        ...
        engineStatus: a.ref("EngineStatus").required(),
        plate: a.string().required(),
        location: a.ref("GeoLocation").required(),
    })
        .authorization((allow) => [
    ...
    allow.resource(myApiFunction).to(["query","mutate"])
