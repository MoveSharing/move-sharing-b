...
async function getItem() {
    ...
    try {
        ...
        const val = await response.body.json();
        console.log('GET call succeeded: ', val);
    } catch (error) {
            ...
            <ScrollView style={{flex: 1}}>
                <View style={[styles.container, {height: 200, flexDirection: "row"}]}>
                    ...
                    <View style={{width: "70%", gap: 10, height: "100%"}}>
                        <View style={[styles.distanceContainer, {backgroundColor: Colors.primary}]}>
                            <Text style={{
                                fontStyle: "italic", fontSize: 16, fontWeight: "900", color: "white",
                                position: "absolute",
                                left: 10,
                                top: 5
                ...
                <View style={styles.container}>
                    <View style={{
                        ...
                        <Text style={{
                            fontStyle: "italic", fontSize: 16, fontWeight: "900", color: Colors.secondary,
                            position: "absolute",
                            left: 10,
                            top: 10
                        }}>Model</Text>
